package com.example.filmeFinder.domain.entity;
...
public class MovieEntity {
    ...
    public MovieEntity(String id, String search, String title, String originalTitle, String gender, String releaseDate, boolean adult, double popularity, int voteCount) {
        this.id = id;
        this.search = search;
        this.title = title;
